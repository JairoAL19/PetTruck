            ...
            <div id="porque_elegir">
                ...
                <div class="margen">
                    <div style="width: fit-content; margin-left: auto;margin-right: auto; margin-bottom: 4%">
                ...
                <div id="ns_text">
                    ...
                    <div id="ns_div1">
                        ...
                        <div id="ns_div1_sec1">
                            ...
                            <div id="subra_rojo"></div>
                            <p id="ns_sec1_p2">¡La personalidad de tu mascota! Con nuestros especialistas, tu engreído quedará irresistible ¡y chau arañones!</p>
                        </div>
                        <div id="ns_div1_sec1">
                            <img src="/img/pipetas2.png">
                            <p id="ns_sec1_p1">PIPETAS ANTI-PARÁSITOS</p>
                            <div id="subra_rojo"></div>
                            <p id="ns_sec1_p2">¡No dejes que los invadan! Colocamos pipetas antipulgas y antigarrapatas para que tu mascota esté siempre protegida. </p>
                        </div>
                    </div>
                    <div id="ns_div1">
                        <div id="ns_div1_sec1">
                            ...
                            <div id="subra_rojo"></div>
                            <p id="ns_sec1_p2">No pierdas de vista a tu mascota, con este Microchip podrás estar tranquilo. ¡El te ama tanto como tu a él! </p>
                        </div>
                        <div id="ns_div1_sec1">
                        ...
                        <div id="ns_div1_sec1">
                            ...
                            <div id="subra_rojo"></div>
                            <p id="ns_sec1_p2">Evita las enfermedades bacterianas y por parásitos. ¡Recomendamos que sea cada 3 meses!</p>
                        </div>                        
                    </div>
                    ...
                    <div id="ns_div1">
                        <div id="ns_div1_sec1">
                            ...
                            <div id="subra_rojo"></div>
                            <p id="ns_sec1_p2">¡Nuestros principales servicios dentro de tu hogar! Estos pueden ser: Baño medicado, Peluquería y Paticure, Aplicación de Pipetas Anti-Parásitos.</p>
                        </div>
                        <div id="ns_div1_sec1">
                        ...
                        <div id="ns_div1_sec1">
                            ...
                            <div id="subra_rojo"></div>
                            <p id="ns_sec1_p2">Tus perritos estarán contentos de pasear en grupo y conocer amigos. ¡Un momento de relax y socialización!</p>
                        </div>                        
                    </div>
